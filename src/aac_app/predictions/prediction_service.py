...
from aac_app.predictions.beam_search import (
    WordPredictionBeamSearch,
...
class PredictionService:
    ...
    def request_predictions(self, text: str, cursor_position: int):
        ...
        self._request_queue.put({"text": text, "cursor_position": cursor_position})
        ...
        while self._running:
            try:
                ...
                predictions = self._generate_predictions(
                    request["text"], request["cursor_position"]
                )
    ...
    def _generate_predictions(self, text: str, cursor_position: int) -> list[str]:
        ...
        if self._use_real_model and self._beam_searcher is not None:
            ...
            try:
                ...
                top_words = self._beam_searcher.get_top_k_words(
                    context, k=self._n_words
                )
